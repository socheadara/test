            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <input type="text"  class="form-control" id="code" name="code" required autofocus value="{{old('code')}}">
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <textarea name="description" id="description" class="form-control" cols="30" rows="1">{{old('description')}}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <div style="margin-top: 9px">
                                <img src="" alt="photo" id="img" width="150">
                            </div>
                        </div>
                    </div>
                </div>
