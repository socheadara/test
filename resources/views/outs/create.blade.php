...
<form>
    <div class="card card-gray">
        <div class="toolbox">
            <button class="btn btn-sm btn-primary btn-oval" type="button" onclick="save()">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row">
                        <label for="out_date"  class="col-sm-5">  Out Date <span class="text-danger">*</span></label>
                        <div class="col-sm-7">
                            <input type="date"  class="form-control" id="out_date" name="out_date" required autofocus value="{{old('out_date')}}">
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
